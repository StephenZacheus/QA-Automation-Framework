...
//        search.sendKeys("pluto");
        ...
        WebElement createPlaylist = driver.findElement(By.xpath("//i[@title='Create a new playlist']"));
        createPlaylist.click();

        WebElement createNewPlaylist = driver.findElement(By.xpath("//li[@data-testid='playlist-context-menu-create-simple']"));
        createNewPlaylist.click();

        WebElement typeNewPlaylist = driver.findElement(By.xpath("// input [@placeholder='↵ to save']"));
        typeNewPlaylist.sendKeys("Awesome Playlist");
        typeNewPlaylist.click();

        WebElement playlistTitle = driver.findElement(By.xpath("//div[@class='heading-wrapper']"));
        playlistTitle.isDisplayed();
